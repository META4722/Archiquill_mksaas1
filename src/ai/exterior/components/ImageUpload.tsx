...
import { validateImageFile } from '../lib/exterior-helpers';
...
export function ImageUpload({ onImageSelect, selectedImage, disabled }: ImageUploadProps) {
  const t = useTranslations('AIExteriorPage.upload');
  ...
  return (
    <div className="w-full space-y-2">
      <div
        ...
        onDrop={async (e) => { e.preventDefault(); setIsDragging(false); if (!disabled) { const f = e.dataTransfer.files[0]; if (f) await handleFile(f); } }}
